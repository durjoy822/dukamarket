...
@section('body')
    ...
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Brand Edit Form</h5>
            <form action="{{route('admin-brand.update',['id'=>$brand->id])}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="text" name="name" value="{{$brand->name}}" value="{{old('name')}}" class="form-control" id="input49" placeholder="Brand Name">
                        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <textarea class="form-control"  name="description" value="{{old('description')}}" id="input50" placeholder="Brand Description" >{{$brand->description}}</textarea>
                        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        ...
                        <img src="{{asset($brand->image)}}" class="img-fluid mt-2" style="width: 70px">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="form-check">
                            <div class="form-check">
                                <input class="form-check-input" {{$brand->status==1?'checked':''}} name="status" value="1" type="radio"  id="flexRadioDefault1" checked>
                                <label class="form-check-label" for="flexRadioDefault1">Published</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" {{$brand->status==0?'checked':''}} name="status" value="0" type="radio" id="flexRadioDefault2" >
