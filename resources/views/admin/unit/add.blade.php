...
@section('body')
    ...
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Unit Add Form</h5>
            <form action="{{route('admin-unit.store')}}" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="text" name="name" value="{{old('name')}}" class="form-control" id="input49" placeholder="Unit Name">
                        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-text"><i class="bi bi-person-fill"></i></span>
                            <input type="text" name="code" value="{{old('code')}}" class="form-control" id="input52" placeholder="Unit Code">
                        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <textarea class="form-control"  name="description" value="{{old('description')}}" id="input50" placeholder="Unit Description" ></textarea>
                        </div>
