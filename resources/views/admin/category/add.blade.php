...
@section('body')
    ...
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Category Add Form</h5>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        ...
                        <input type="text" name="name" value="{{old('name')}}" class="form-control" id="input49" placeholder="Category Name">
                    </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        <textarea class="form-control"  name="description" value="{{old('description')}}" id="input49" placeholder="Category Description" ></textarea>
                    </div>
